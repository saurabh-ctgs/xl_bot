...
class AppConst {
  static const String geminiApiKey = 'AIzaSyBwHqhP37UeDC6uWMmR6zZL2ySxmUss68U';
  ...
  // static String supabaseFunctionUrl = 'https://twnvmbrenpkqdvovhmze.supabase.co/functions/v1/make-server-1707a7e2/chat';
